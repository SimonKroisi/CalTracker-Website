...
8. If neither app is CalTracker: a short, clearly-marked "where CalTracker fits" box (price, anonymous mode, offline) — one box, not a hijack. If CalTracker loses a dimension, say so; conceding is the credibility play.
